  ...
  return (
    <section aria-labelledby="what-is-hacknc-heading">
      <div className="mx-4 grid items-center gap-10 sm:mx-8 lg:mx-12 lg:grid-cols-[minmax(0,7fr)_minmax(0,3fr)] lg:gap-16">
        ...
        <div className="relative rounded-window bg-linear-to-br from-[#2b62c4] from-0% via-[#5f93dd] via-55% to-[#a8c6ec] to-100% p-2 pt-3 shadow-[0_10px_28px_rgba(23,55,113,0.28)] sm:p-2.5 sm:pt-4">
          <div className="flex items-center justify-between gap-4 px-4 pb-3 sm:px-6">
            <h2
              id="what-is-hacknc-heading"
              className="font-title text-section tracking-title text-white [text-shadow:0_2px_6px_rgba(23,55,113,0.55)]"
            >
              What is HackNC ?
            </h2>
          ...
          <div className="space-y-5 rounded-inset rounded-tr-[34px] bg-white px-6 py-7 shadow-[0_2px_6px_rgba(23,55,113,0.18)] sm:px-9 sm:py-9">
            <p className="font-body text-body leading-7 tracking-body text-ink sm:leading-8">
